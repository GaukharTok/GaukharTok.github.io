  ...
  fetch("https://randomuser.me/api/?results=8")
    ...
    .then((data) => {
      ...
      const userTemplates = users
        ...
        <img src="${large}" alt="Profile Picture" class ="profile-pic">
...
<div class = "contact-info">
    ...
    <p><i class="fa-solid fa-phone"></i>Phone: ${cell}</p>
</div>
</div>`;
        })
        .join("");
      document.body.insertAdjacentHTML("beforeend", userTemplates);
    })
